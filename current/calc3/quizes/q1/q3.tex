...
Start with our previous expression and sum but instead of n we push it to infinity
\[
\lim_{ n \to \infty} \ln^{  } \left( \frac{ \sqrt[ n ]{ n! }  }{ n } \right) =\lim_{ n \to \infty} \sum_{ i=1 } ^{ n } \ln^{  } \left( \frac{ i }{ a }  \right) 
...
Find 
\[
\lim_{ n \to \infty} \frac{ \sqrt[ n ]{ n! }  }{ n } \implies 
.\] 
\newpage
\section*{Question 6}%
