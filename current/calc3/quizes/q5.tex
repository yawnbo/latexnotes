...
\def\axisSettings{
    ...
    x label style={at={(axis cs:3.8,0)}, anchor=west},
    y label style={at={(axis cs:0,2.3)}, anchor=south},
    width=6cm,
    height=6cm
}
\begin{scope}
    ...
    \foreach \x in {1,2,3}
        \draw[gray!30] (\x,-2) -- (\x,2);
    
    \draw[blue, thick] 
        (0,0.2) .. controls (0.3,1.5) and (0.7,1.8) .. (0.8,1.6)
        .. controls (1,1.2) and (1.2,0) .. (1.5,-1)
        .. controls (1.8,-1.5) and (2.2,-1.2) .. (2.5,-0.5)
        .. controls (2.8,0) and (3,0.5) .. (3.5,0.8);
\end{scope}
\begin{scope}[xshift=7cm]
    \draw[->] (-0.5,0) -- (5.5,0) node[right] {$t$};
    \draw[->] (0,-2) -- (0,2) node[above] {$y(t)$};
    
    \foreach \x in {1,2,3,4,5}
        \draw[gray!30] (\x,-2) -- (\x,2);
    
    \draw[blue, thick] 
        (0,0) .. controls (0.3,-0.5) and (0.6,-1.5) .. (1,-2)
        .. controls (1.5,-1.5) and (2,0) .. (2.5,0.2)
        .. controls (2.21,0) and (3.25,1) .. (4.5,0)
\end{scope}
\end{tikzpicture}
